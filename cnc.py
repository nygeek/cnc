...
class ComplexNumberCalculator:
    ...
    def __init__(self, stack_depth=4):
        ...
        self.buttons = {
            ...
            "acosh": [self.unary, "replace x with acos(x)",
                    cmath.acosh],
                    # lambda _x: cmath.acos(_x)],
...
#                     self.no_op],
            ...
            "sin": [self.unary, "replace x with sin(x)",
                    cmath.sin],
            "sinh": [self.unary, "replace x with sinh(x)",
                    cmath.sinh],
            ...
            "tan": [self.unary, "replace x with tan(x)",
                    cmath.tan],
            "tanh": [self.unary, "replace x with tanh(x)",
                    cmath.tanh],
